      ...
      <div className="p-5 sm:p-8 space-y-5 sm:space-y-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_260px] gap-4">
          <div className="rounded-2xl p-5" style={{ background: C.bg2, border: `1px solid ${C.line}` }}>
            <div className="flex items-center gap-2 mb-4" style={{ color: C.brand }}>
              <Info size={14} />
              <h3 className="text-[13px] font-extrabold uppercase tracking-[0.14em]">Thông số sản phẩm</h3>
            </div>

            <div className="grid grid-cols-2 gap-x-4 gap-y-4 text-sm">
              <div className="col-span-2 pb-2.5" style={{ borderBottom: `1px solid ${C.line}` }}>
                <p className="text-[12px] font-bold uppercase mb-1 tracking-wide" style={{ color: C.sub }}>Vật liệu</p>
              ...
              <div>
                <p className="text-[12px] font-bold uppercase mb-1 tracking-wide" style={{ color: C.sub }}>Khối lượng</p>
                <p className="font-bold" style={{ color: C.ok }}>{params.weightG}g</p>
              </div>
              <div className="text-right">
                <p className="text-[12px] font-bold uppercase mb-1 tracking-wide" style={{ color: C.sub }}>Màu sắc</p>
              ...
              <div>
                <p className="text-[12px] font-bold uppercase mb-1 tracking-wide" style={{ color: C.sub }}>Chiều cao lớp</p>
                <p className="font-bold" style={{ color: C.ink }}>{params.layerHeightMm} mm</p>
              </div>
              <div className="text-right">
                <p className="text-[12px] font-bold uppercase mb-1 tracking-wide" style={{ color: C.sub }}>Độ đặc (infill)</p>
          ...
          >
            {material?.imageUrl ? (
              ...
              <div className="flex flex-col items-center gap-2" style={{ color: '#cbd5e1' }}>
                ...
                <p className="text-[13px] font-bold uppercase tracking-[0.16em]">Chưa có hình mẫu</p>
              </div>
            )}
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-2 mb-2" style={{ color: C.violetHead }}>
            <Sparkles size={15} />
            <h3 className="text-[13px] font-black uppercase tracking-[0.14em]">Đặc tính nhựa {category}</h3>
          </div>
          <p className="text-[13px] font-semibold italic leading-relaxed" style={{ color: C.violetInk }}>
            {characteristics}
          </p>
        </div>
        ...
        <div className="rounded-2xl p-5" style={{ background: C.bg2, border: `1px solid ${C.line}` }}>
          <h3
            className="text-[13px] font-extrabold uppercase tracking-[0.14em] flex items-center gap-2 mb-2.5"
            style={{ color: C.sub }}
          >
            <Info size={14} style={{ color: C.brand }} /> Lưu ý dịch vụ in 3D
          </h3>
          <div className="whitespace-pre-line text-[13px] font-semibold leading-[1.65]" style={{ color: C.sub }}>
            {serviceNotes}
          </div>
        </div>
        ...
        >
          <div className="flex items-center gap-5 sm:gap-7 flex-1">
            ...
            >
              {qrLoading && (
                ...
                >
                  ...
                  <span className="text-[9px] font-black uppercase tracking-[0.16em]" style={{ color: C.brand }}>
                    Đang tải QR
                  </span>
                </div>
              )}
            ...
            <div className="space-y-3.5 min-w-0">
              <div>
                <p className="text-[12px] font-bold uppercase tracking-[0.12em]" style={{ color: C.sub }}>
              ...
              <div>
                <p className="text-[12px] font-bold uppercase tracking-[0.12em]" style={{ color: C.sub }}>Nội dung</p>
          ...
          >
            <p className="text-[12px] font-black uppercase tracking-[0.28em] mb-1.5" style={{ color: 'rgba(255,255,255,0.75)' }}>
              Tổng thanh toán
            </p>
